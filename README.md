...
Cybersecurity practitioner focused on adversary simulation, digital forensics, and detection engineering.

U.S. Coast Guard veteran. M.S. Digital Forensics (GMU, 2026).
...
- USCC Binary Exploits — exploit development tooling used in live competition (2nd place, Cyber Bowl East)
- CVSS Calculator — offline CVSS v3.1 scoring tool used in consulting contexts
